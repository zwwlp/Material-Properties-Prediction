...
from layers_feature_optimization import (NodeEmbedding, GatedGraphConvolution, GraphPooling,
...
class GGNNInput(object):
    def __init__(self, nodes, edge_sources, edge_targets,graph_distance_nbr,graph_indices, node_counts):
        ...
        self.graph_distance_nbr=torch.Tensor(graph_distance_nbr)
    ...
    def to(self, device):
        ...
        self.graph_distance_nbr = self.graph_distance_nbr.to(device)
...
class GGNN(nn.Module):
    ...
    * Tian Xie, et al., "Crystal Graph Convolutional Neural Networks for an Accurate and
    ...
    """
    def __init__(self, n_node_feat, n_hidden_feat, n_graph_feat,n_nbr_fea, n_conv, n_fc,
                 ...
                 postconv_net_activation, use_postconv_net_batch_norm, use_attention,conv_type,feature_encoding,
        ...
        self.convs = [GatedGraphConvolution(n_hidden_feat, n_hidden_feat,n_nbr_fea,dropout,feature_encoding,
                      ...
                      use_distance_nbr=use_distance_nbr,
    ...
    def forward(self, input):
        ...
        for conv, pre_pooling in zip(self.convs, self.pre_poolings):
            x = conv(x, input.edge_sources, input.edge_targets, input.graph_distance_nbr)#
